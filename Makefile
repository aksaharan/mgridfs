...
LIBS=-lfuse -lulockmgr -lmongoclient -lboost_system -lboost_thread -lpthread
...
mgridfs: fs_options.o file_meta_ops.o fs_meta_ops.o dir_meta_ops.o fs_conn_info.o fs_logger.o main.o
