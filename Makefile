...
mgridfs: file_handle.o local_grid_file.o local_gridfs.o utils.o fs_options.o file_meta_ops.o fs_meta_ops.o dir_meta_ops.o \
fs_conn_info.o fs_logger.o main.o
